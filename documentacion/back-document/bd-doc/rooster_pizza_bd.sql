...
--
-- Telemetría de rendimiento (2026-08-09): tabla request_timings.
-- La escribe el middleware App\Http\Middleware\LogRequestTiming en cada request.
-- No pertenece al esquema de dominio (telemetría). Aditiva y re-ejecutable.
-- Fuente incremental: bd-doc/migracion_2026-08-09_request_timings.sql
--
