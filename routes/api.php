...
Route::middleware([LogRequestTiming::class])->group(function () {
    ...
    // 'sede.abierta': si la sede del admin esta cerrada, su panel queda en SOLO
    // LECTURA (puede consultar todo su historial, pero no modificar).
    Route::middleware(['auth:sanctum', 'password.valida', 'role:super_admin,admin_sede', 'sede.abierta'])
        ->prefix('admin')
        ->group(function () {
            // Productos
            ...
            // Sucursales: solo LECTURA para el admin. El alta y la edicion de sedes
            // viven unicamente en el panel de superadmin (/superadmin/sedes), para
            // que exista un solo lugar donde se dan de alta.
    ...
    Route::prefix('superadmin')->group(function () {
        ...
        Route::middleware(['auth:sanctum', 'superadmin'])->group(function () {
            ...
            // Sedes del negocio: comparten menu, precios, ofertas y clientes; solo
            // se separan los pedidos. Es el UNICO lugar donde se dan de alta.
            Route::get('/sedes', [SedeController::class, 'index']);
            Route::post('/sedes', [SedeController::class, 'store']);
            Route::match(['put', 'patch'], '/sedes/{id}', [SedeController::class, 'update']);
            // Cierre / reapertura de una sede (no borra nada; ver SedeController).
            Route::post('/sedes/{id}/estado', [SedeController::class, 'cambiarEstado']);
